...
void pattern_ffi_slice_7(my_library_slice_mut_const_i8 ignored);
...
my_library_ffi_error pattern_callback_7(my_library_sum_delegate_return callback, int32_t x);
