...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        public static byte simple_servicemethod_mut_self(IntPtr context, byte[] slice)
        {
            unsafe
            {
                fixed (void* ptr_slice = slice)
        ...
        /// Single line.
        public static void simple_servicemethod_mut_self_void(IntPtr context, Bool[] slice)
        {
            unsafe
            {
                fixed (void* ptr_slice = slice)
        ...
        public static byte simple_servicemethod_mut_self_ref_slice(IntPtr context, ref byte x, out byte y, byte[] slice)
        {
            unsafe
            {
                fixed (void* ptr_slice = slice)
        ...
        public static byte simple_servicemethod_mut_self_ref_slice_limited(IntPtr context, ref byte x, out byte y, byte[] slice, byte[] slice2)
        {
            unsafe
            {
                fixed (void* ptr_slice = slice)
        ...
        public static void simple_servicemethod_mut_self_ffi_error(IntPtr context, byte[] slice)
        {
            unsafe
            {
                fixed (void* ptr_slice = slice)
        ...
        public static void simple_servicemethod_mut_self_no_error(IntPtr context, byte[] slice)
        {
            unsafe
            {
                fixed (void* ptr_slice = slice)
        ...
        public static void simple_service_lifetimemethod_lt(IntPtr context, Bool[] slice)
        {
            unsafe
            {
                fixed (void* ptr_slice = slice)
        ...
        public static void simple_service_lifetimemethod_lt2(IntPtr context, Bool[] slice)
        {
            unsafe
            {
                fixed (void* ptr_slice = slice)
        ...
        public static string simple_service_lifetimereturn_string_accept_slice(IntPtr anon0, byte[] anon1)
        {
            unsafe
            {
