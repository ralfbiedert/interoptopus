...
namespace Gen.ForCSharp
{
    public static partial class Interop
    {
        ...
        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_create_10735800234383968700")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_create_10735800234383968700(IntPtr data, ulong len, ref VecFItem rval);


        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_destroy_7947997024561536818")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_destroy_7947997024561536818(VecFItem ignored);


        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_create_15861125109924504304")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_create_15861125109924504304(IntPtr data, ulong len, ref VecFResult rval);


        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_destroy_8638515020319474536")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_destroy_8638515020319474536(VecFResult ignored);
    ...
    public partial class VecFItem : IDisposable
    {
        ...
        {
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_create_10735800234383968700")]
            internal static partial long interoptopus_vec_create(IntPtr vec, ulong len, out Unmanaged rval);
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_destroy_7947997024561536818")]
    ...
    public partial class VecFResult : IDisposable
    {
        ...
        public partial class InteropHelper
        {
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_create_15861125109924504304")]
            internal static partial long interoptopus_vec_create(IntPtr vec, ulong len, out Unmanaged rval);
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_destroy_8638515020319474536")]
            internal static partial long interoptopus_vec_destroy(Unmanaged vec);
        }
