    ...
    fn to_typespecifier_in_field(&self, x: &CType, field: &Field, composite: &CompositeType) -> String {
        match &x {
            ...
            CType::Pattern(x) => match x {
                ...
                TypePattern::InstantCallback(e) => self.named_callback_to_typename(e),
                TypePattern::RetainedCallback(e) => self.named_callback_to_typename(e),
    ...
    fn to_typespecifier_in_param(&self, x: &CType) -> String {
        match &x {
            ...
            CType::Pattern(x) => match x {
                ...
                TypePattern::InstantCallback(x) => self.named_callback_to_typename(x),
                TypePattern::RetainedCallback(x) => self.named_callback_to_typename(x),
                TypePattern::Bool => "Bool".to_string(),
                TypePattern::CChar => "sbyte".to_string(),
