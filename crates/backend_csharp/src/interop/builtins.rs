...
pub fn write_builtins(i: &Interop, w: &mut IndentWriter) -> Result<(), Error> {
    ...
    if i.write_types.write_interoptopus_globals() {
        ...
        indented!(w, [()()()], r"_ptr = rval._ptr;")?;
        indented!(w, [()()()], r"_len = rval._len;")?;
        indented!(w, [()()()], r"_capacity = rval._capacity;")?;
        indented!(w, [()()], r"}}")?;
        w.newline()?;
        indented!(w, [()], r"}}")?;
        w.newline()?;
        ...
        w.newline()?;
        i.inline_hint(w, 2)?;
        indented!(w, [()()], r"public Utf8String ToManaged()")?;
        indented!(w, [()()], r"{{")?;
        indented!(w, [()()()], r"var marshaller = new Marshaller(this);")?;
        ...
        indented!(w, [()()()], r"_managed._ptr = IntPtr.Zero;")?;
        indented!(w, [()()()], r"return _unmanaged;")?;
        indented!(w, [()()], r"}}")?;
        w.newline()?;
