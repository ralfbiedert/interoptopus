...
pub fn write_async_helper(i: &Interop, w: &mut IndentWriter) -> Result<(), Error> {
    if i.write_types.write_interoptopus_globals() {
        indented!(w, "#region \"RecyclableTaskCompletionSource\"")?;
        ...
        indented!(w, r"file sealed class RecyclableTaskCompletionSource : IValueTaskSource")?;
        indented!(w, r"{{")?;
        indented!(w, [()], r"private static readonly ConcurrentDictionary<int, RecyclableTaskCompletionSource> Registered = new();")?;
        indented!(w, [()], r"// ReSharper disable once StaticMemberInGenericType")?;
        indented!(w, [()], r"private static int _nextId;")?;
        w.newline()?;
        indented!(w, [()], r"private static readonly ConcurrentQueue<RecyclableTaskCompletionSource> Pool = new();")?;
        w.newline()?;
        indented!(w, [()], r"[MethodImpl(MethodImplOptions.AggressiveInlining)]")?;
        indented!(w, [()], r"public static RecyclableTaskCompletionSource GetById(int id) => Registered[id];")?;
        w.newline()?;
        indented!(w, [()], r"public int Id {{ [MethodImpl(MethodImplOptions.AggressiveInlining)] get; }}")?;
        w.newline()?;
        indented!(w, [()], r"[MethodImpl(MethodImplOptions.AggressiveOptimization)]")?;
        indented!(w, [()], r"public static RecyclableTaskCompletionSource Get()")?;
        indented!(w, [()], r"{{")?;
        indented!(w, [()()()], r"if (Pool.TryDequeue(out var recyclableTaskCompletionSource))")?;
        indented!(w, [()()()()], r"return recyclableTaskCompletionSource;")?;
        indented!(w, [()()()], r"return new RecyclableTaskCompletionSource();")?;
        indented!(w, [()], r"}}")?;
        w.newline()?;
        indented!(w, [()], r"private RecyclableTaskCompletionSource()")?;
        indented!(w, [()], r"{{")?;
        ...
        indented!(w, [()], r"}}")?;
        w.newline()?;
        indented!(w, [()], r"private ManualResetValueTaskSourceCore<int> _core;")?;
        w.newline()?;
        indented!(w, [()], r"internal ValueTask GetTask() => new(this, _core.Version);")?;
        w.newline()?;
        indented!(w, [()], r"void IValueTaskSource.GetResult(short token) => GetResult(token);")?;
        w.newline()?;
        indented!(w, [()], r"private void GetResult(short token)")?;
        indented!(w, [()], r"{{")?;
        indented!(w, [()()], r"try")?;
        indented!(w, [()()], r"{{")?;
        indented!(w, [()()()], r"_core.GetResult(token);")?;
        indented!(w, [()()], r"}}")?;
        indented!(w, [()()], r"finally")?;
        indented!(w, [()()], r"{{")?;
        indented!(w, [()()()], r"_core.Reset();")?;
        ...
        indented!(w, [()], r"}}")?;
        w.newline()?;
        indented!(w, [()], r"ValueTaskSourceStatus IValueTaskSource.GetStatus(short token) => _core.GetStatus(token);")?;
        w.newline()?;
        indented!(w, [()], r"void IValueTaskSource.OnCompleted(Action<object> continuation, object state, short token, ValueTaskSourceOnCompletedFlags flags) => ")?;
        indented!(w, [()()], r"_core.OnCompleted(continuation, state, token, flags);")?;
        w.newline()?;
        indented!(w, [()], r"[MethodImpl(MethodImplOptions.AggressiveInlining)]")?;
        indented!(w, [()], r"public void SetResult() => _core.SetResult(0);")?;
        w.newline()?;
        indented!(w, [()], r"[MethodImpl(MethodImplOptions.AggressiveInlining)]")?;
        indented!(w, [()], r"public void SetException(Exception result) => _core.SetException(result);")?;
        indented!(w, r"}}")?;
