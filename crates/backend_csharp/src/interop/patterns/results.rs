// pub fn write_pattern_result(i: &Interop, w: &mut IndentWriter, result: &ResultType) -> Result<(), Error> {
//     i.debug(w, "write_pattern_result")?;
//
//     let err_name = to_typespecifier_in_param(result.e());
//     let name = result.the_enum().rust_name();
//     let e = result.e();
//     let t = result.t();
//
...
//     indented!(w, [()], r"{{")?;
//     indented!(w, [()()], r"if (err == 0 /* TODO */)")?;
//     indented!(w, [()()], r"{{")?;
//     indented!(w, [()()()], r"return t;")?;
//     indented!(w, [()()], r"}}")?;
//     indented!(w, [()()], r"throw new InteropException<{err_name}>(err);")?;
//     indented!(w, [()], r"}}")?;
//     w.newline()?;
//     indented!(w, [()], r"public bool IsOk() {{ return err == 0 /* TODO */; }}")?;
//     indented!(w, [()], r"public {err_name} Err() {{ return err; }}")?;
//     w.newline()?;
//
...
//     indented!(w, r"if (_managed.err == 0 /* TODO */)")?;
//     indented!(w, r"{{")?;
//     w.indent();
