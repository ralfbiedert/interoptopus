...
fn intptr_eligibility(ty: TypeId, types: &model::common::types::all::Pass) -> IntPtrEligibility {
...
/// Check whether an argument type is an `IntPtr` whose pointee is eligible for `ref` overloads.
fn is_eligible_intptr(ty: TypeId, types: &model::common::types::all::Pass) -> bool {
