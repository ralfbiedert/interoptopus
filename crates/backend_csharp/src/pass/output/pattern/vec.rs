...
impl Pass {
    ...
    pub fn process(
        ...
        pattern_vec: &model::pattern::vec::Pass,
    ) -> OutputResult {
        ...
        for file in output_master.outputs_of(FileType::Csharp) {
            ...
            for (type_id, ty) in types.iter() {
                ...
                let rendered = if is_blittable {
                    ...
                    templates.render("pattern/vec/fast.cs", &context)?
                } else {
                    ...
                    context.insert("create_entry_point", &helpers.create_entry_point);
                    context.insert("destroy_entry_point", &helpers.destroy_entry_point);
                    templates.render("pattern/vec/marshalling.cs", &context)?
                };
