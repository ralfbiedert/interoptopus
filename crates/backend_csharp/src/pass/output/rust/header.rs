...
impl Pass {
    ...
    pub fn process(&mut self, _pass_meta: &mut crate::pass::PassMeta, output_master: &output::common::master::Pass, meta_info: &meta::rust::info::Pass) -> OutputResult {
        ...
        for output in output_master.outputs_of(FileType::Csharp) {
            ...
            let header = templates.render("rust/header.cs", &context)?;
