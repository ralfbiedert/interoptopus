...
impl Pass {
    ...
    pub fn process(
        ...
        enum_body_unmanaged_variant: &output::rust::types::enums::body_unmanaged_variant::Pass,
        enum_body_unmanaged: &output::rust::types::enums::body_unmanaged::Pass,
        enum_body_to_unmanaged: &output::rust::types::enums::body_to_unmanaged::Pass,
        enum_body_as_unmanaged: &output::rust::types::enums::body_as_unmanaged::Pass,
        enum_body_ctors: &output::rust::types::enums::body_ctors::Pass,
        enum_body_exception_for_variant: &output::rust::types::enums::body_exception_for_variant::Pass,
        enum_body_tostring: &output::rust::types::enums::body_tostring::Pass,
