//! Emits C# serialization, deserialization, and size calculation statements.
//!
//! This module is a shared utility used by the wire output passes. It walks the
//! Rust type graph recursively, translating primitives, `WireOnly` types, and
//! user structs into inline C# statements. Type name mapping is delegated to
//! [`model::wire`](crate::pass::model::wire).
