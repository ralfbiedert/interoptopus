...
pub struct RustLibraryConfig {
    ...
    pub model_type_managed_conversion: model::rust::types::info::managed_conversion::Config,
    pub model_type_disposable: model::rust::types::info::disposable::Config,
    pub model_type_nullable: model::rust::types::info::nullable::Config,
    pub model_type_struct_class: model::rust::types::info::struct_class::Config,
    ...
    pub model_type_util: model::rust::types::util::Config,
    ...
    pub output_unmanaged_conversion: output::rust::conversion::unmanaged_conversion::Config,
    pub output_unmanaged_names: output::rust::conversion::unmanaged_names::Config,
    pub output_conversion_fields: output::rust::conversion::fields::Config,
    pub output_enum_ty: output::rust::types::enums::definition::Config,
    pub output_enum_body: output::rust::types::enums::body::Config,
    pub output_enum_body_unmanaged_variant: output::rust::types::enums::body_unmanaged_variant::Config,
    pub output_enum_body_unmanaged: output::rust::types::enums::body_unmanaged::Config,
    pub output_enum_body_to_unmanaged: output::rust::types::enums::body_to_unmanaged::Config,
    pub output_enum_body_as_unmanaged: output::rust::types::enums::body_as_unmanaged::Config,
    pub output_enum_body_ctors: output::rust::types::enums::body_ctors::Config,
    pub output_enum_body_exception_for_variant: output::rust::types::enums::body_exception_for_variant::Config,
    pub output_enum_body_tostring: output::rust::types::enums::body_tostring::Config,
    pub output_enum: output::rust::types::enums::all::Config,
    pub output_composite_ty: output::rust::types::composites::definition::Config,
    pub output_composite_body: output::rust::types::composites::body::Config,
    pub output_composite_body_unmanaged: output::rust::types::composites::body_unmanaged::Config,
    pub output_composite_body_to_unmanaged: output::rust::types::composites::body_to_unmanaged::Config,
    pub output_composite_body_as_unmanaged: output::rust::types::composites::body_as_unmanaged::Config,
    pub output_composite: output::rust::types::composites::all::Config,
...
pub struct ModelPasses {
    ...
    pub type_managed_conversion: model::rust::types::info::managed_conversion::Pass,
    pub type_disposable: model::rust::types::info::disposable::Pass,
    pub type_nullable: model::rust::types::info::nullable::Pass,
    pub type_struct_class: model::rust::types::info::struct_class::Pass,
    ...
    pub type_util: model::rust::types::util::Pass,
...
pub struct IntermediateOutputPasses {
    pub unmanaged_conversion: output::rust::conversion::unmanaged_conversion::Pass,
    pub unmanaged_names: output::rust::conversion::unmanaged_names::Pass,
    pub conversion_fields: output::rust::conversion::fields::Pass,
    pub enum_ty: output::rust::types::enums::definition::Pass,
    pub enum_body_unmanaged_variant: output::rust::types::enums::body_unmanaged_variant::Pass,
    pub enum_body_unmanaged: output::rust::types::enums::body_unmanaged::Pass,
    pub enum_body_to_unmanaged: output::rust::types::enums::body_to_unmanaged::Pass,
    pub enum_body_as_unmanaged: output::rust::types::enums::body_as_unmanaged::Pass,
    pub enum_body_ctors: output::rust::types::enums::body_ctors::Pass,
    pub enum_body_exception_for_variant: output::rust::types::enums::body_exception_for_variant::Pass,
    pub enum_body_tostring: output::rust::types::enums::body_tostring::Pass,
    pub enum_body: output::rust::types::enums::body::Pass,
    pub enums: output::rust::types::enums::all::Pass,
    pub composite_ty: output::rust::types::composites::definition::Pass,
    pub composite_body_unmanaged: output::rust::types::composites::body_unmanaged::Pass,
    pub composite_body_to_unmanaged: output::rust::types::composites::body_to_unmanaged::Pass,
    pub composite_body_as_unmanaged: output::rust::types::composites::body_as_unmanaged::Pass,
    pub composite_body: output::rust::types::composites::body::Pass,
    pub composites: output::rust::types::composites::all::Pass,
    ...
    pub(crate) fn with_config(inventory: RustInventory, config: RustLibraryConfig) -> Self {
        Self {
            ...
            model_passes: ModelPasses {
                ...
                type_managed_conversion: model::rust::types::info::managed_conversion::Pass::new(config.model_type_managed_conversion),
                type_disposable: model::rust::types::info::disposable::Pass::new(config.model_type_disposable),
                type_nullable: model::rust::types::info::nullable::Pass::new(config.model_type_nullable),
                type_struct_class: model::rust::types::info::struct_class::Pass::new(config.model_type_struct_class),
                ...
                type_util: model::rust::types::util::Pass::new(config.model_type_util),
            ...
            output_passes: IntermediateOutputPasses {
                unmanaged_conversion: output::rust::conversion::unmanaged_conversion::Pass::new(config.output_unmanaged_conversion),
                unmanaged_names: output::rust::conversion::unmanaged_names::Pass::new(config.output_unmanaged_names),
                conversion_fields: output::rust::conversion::fields::Pass::new(config.output_conversion_fields),
                enum_ty: output::rust::types::enums::definition::Pass::new(config.output_enum_ty),
                enum_body_unmanaged_variant: output::rust::types::enums::body_unmanaged_variant::Pass::new(config.output_enum_body_unmanaged_variant),
                enum_body_unmanaged: output::rust::types::enums::body_unmanaged::Pass::new(config.output_enum_body_unmanaged),
                enum_body_to_unmanaged: output::rust::types::enums::body_to_unmanaged::Pass::new(config.output_enum_body_to_unmanaged),
                enum_body_as_unmanaged: output::rust::types::enums::body_as_unmanaged::Pass::new(config.output_enum_body_as_unmanaged),
                enum_body_ctors: output::rust::types::enums::body_ctors::Pass::new(config.output_enum_body_ctors),
                enum_body_exception_for_variant: output::rust::types::enums::body_exception_for_variant::Pass::new(config.output_enum_body_exception_for_variant),
                enum_body_tostring: output::rust::types::enums::body_tostring::Pass::new(config.output_enum_body_tostring),
                enum_body: output::rust::types::enums::body::Pass::new(config.output_enum_body),
                enums: output::rust::types::enums::all::Pass::new(config.output_enum),
                composite_ty: output::rust::types::composites::definition::Pass::new(config.output_composite_ty),
                composite_body_unmanaged: output::rust::types::composites::body_unmanaged::Pass::new(config.output_composite_body_unmanaged),
                composite_body_to_unmanaged: output::rust::types::composites::body_to_unmanaged::Pass::new(config.output_composite_body_to_unmanaged),
                composite_body_as_unmanaged: output::rust::types::composites::body_as_unmanaged::Pass::new(config.output_composite_body_as_unmanaged),
                composite_body: output::rust::types::composites::body::Pass::new(config.output_composite_body),
                composites: output::rust::types::composites::all::Pass::new(config.output_composite),
