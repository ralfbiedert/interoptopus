...
pub fn inventory() -> RustInventory {
    RustInventory::new()
        ...
        .register(function!(patterns::callback::pattern_callback_9))
        ...
        .register(function!(wire::option::wire_option_2))
        .register(function!(wire::option::wire_option_3))
        .register(function!(wire::option::wire_option_4))
        // Constants
        ...
        .register(service!(services::asynk::cross_service::ServiceProduced))
        .register(service!(services::asynk::cross_service::ServiceFactory))
