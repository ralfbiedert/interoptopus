...
cp "$PROJECT_ROOT"/interoptopus_backend_csharp/tests/output/Interop.common.cs "$PROJECT_ROOT"/interoptopus_backend_csharp/tests/output/Interop.common.cs.expected
