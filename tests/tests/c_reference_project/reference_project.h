...
typedef UTF8STRING (*STRINGCALLBACKSTRING)(UTF8STRING S, const void* CALLBACK_DATA);
...
ptrdiff_t primitive_isize(ptrdiff_t X);
...
int32_t pattern_callback_9(POINTERS X);

void pattern_callback_10(STRINGCALLBACKSTRING IGNORED);
...
void wire_accept_string_2(void * INPUT);
...
///  The passed parameter MUST have been created with the corresponding init function;
///  passing any other value results in undefined behavior.
RESULTCONSTPTRSERVICEASYNCNEWERROR service_async_new_destroy(const SERVICEASYNCNEW* _CONTEXT);

RESULTCONSTPTRSERVICEASYNCNEWERROR service_async_new_new(const WRAPPER* _CONTEXT, fptr_fn_ConstPtrResultConstPtrServiceAsyncNewError_ConstPtrVoid_rval_void _ASYNC_CALLBACK);

RESULTERROR service_async_new_call(const SERVICEASYNCNEW* _CONTEXT, fptr_fn_ConstPtrResultError_ConstPtrVoid_rval_void _ASYNC_CALLBACK);
...
///  The passed parameter MUST have been created with the corresponding init function;
///  passing any other value results in undefined behavior.
RESULTCONSTPTRWRAPPERERROR wrapper_destroy(const WRAPPER* _CONTEXT);

RESULTCONSTPTRWRAPPERERROR wrapper_new();
...
///  The passed parameter MUST have been created with the corresponding init function;
///  passing any other value results in undefined behavior.
RESULTCONSTPTRSERVICEASYNCLOADERROR service_async_load_destroy(const SERVICEASYNCLOAD* _CONTEXT);

RESULTCONSTPTRSERVICEASYNCLOADERROR service_async_load_new();

RESULTERROR service_async_load_load(const SERVICEASYNCLOAD* _CONTEXT, uint32_t X, fptr_fn_ConstPtrResultU32Error_ConstPtrVoid_rval_void _ASYNC_CALLBACK);
...
///  The passed parameter MUST have been created with the corresponding init function;
///  passing any other value results in undefined behavior.
RESULTCONSTPTRSERVICEASYNCVECSTRINGERROR service_async_vec_string_destroy(const SERVICEASYNCVECSTRING* _CONTEXT);

RESULTCONSTPTRSERVICEASYNCVECSTRINGERROR service_async_vec_string_new();

RESULTERROR service_async_vec_string_handle_string(const SERVICEASYNCVECSTRING* _CONTEXT, UTF8STRING S, fptr_fn_ConstPtrResultUtf8StringError_ConstPtrVoid_rval_void _ASYNC_CALLBACK);
