...
namespace My.Company.Common
{
    ...
    public partial struct EnumNum 
    {
        ...
        public static EnumNum A(ulong value) => new() { _variant = 0, _A = value };
        public static EnumNum B => new() { _variant = 1 };
        public static EnumNum C(long value) => new() { _variant = 2, _C = value };

        public bool IsA => _variant == 0;
        public bool IsB => _variant == 1;
        public bool IsC => _variant == 2;

        public ulong AsA() { if (_variant != 0) { throw new InteropException(); } else { return _A; } }
        public void AsB() { if (_variant != 1) throw new InteropException(); }
        public long AsC() { if (_variant != 2) { throw new InteropException(); } else { return _C; } }
