...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0x1532b57ea84fca49)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0x1532b57ea84fca49). You probably forgot to update / copy either the bindings or the library.");
            }
        }
        ...
        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_create_6754850874721651329")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_create_6754850874721651329(IntPtr data, ulong len, ref VecSliceU8 rval);


        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_destroy_5722710969548806095")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_destroy_5722710969548806095(VecSliceU8 ignored);
    ...
    public partial class UseSliceAndVec : IDisposable
    {
        ...
        internal unsafe Unmanaged IntoUnmanaged()
        {
            ...
            _unmanaged.s3 = s3.IntoUnmanaged();
            _unmanaged.s4 = s4.ToUnmanaged();
            return _unmanaged;
        }
        ...
        public unsafe struct Unmanaged
        {
            ...
            public VecSliceU8.Unmanaged s3;
            public SliceU8.Unmanaged s4;
            ...
            internal unsafe UseSliceAndVec IntoManaged()
            {
                ...
                _managed.s3 = s3.IntoManaged();
                _managed.s4 = s4.ToManaged();
                return _managed;
            }
        }
