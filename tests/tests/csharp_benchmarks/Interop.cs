...
namespace My.Company
{
    ...
    public struct AsyncTrampolineResultError
    {
        ...
        private static Dictionary<ulong, TaskCompletionSource<ResultError>> InFlight = new(1024);
        ...
        {
            TaskCompletionSource<ResultError> tsc;

            lock (InFlight) { InFlight.Remove((ulong) csPtr, out tsc); }
            ...
            if (managed.IsOk) { tsc.SetResult(managed); }
            else { tsc.SetException(new InteropException()); }
        }

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public (AsyncCallbackCommonNative, Task) NewCall()
        {
            var tcs = new TaskCompletionSource<ResultError>();
            var id = Id++;
    ...
    public static partial class Interop
    {
        ...
        private static AsyncTrampolineResultError _trampolineResultError;
        ...
        static Interop()
        {
            ...
            _trampolineResultError = new AsyncTrampolineResultError();
        }
        ...
        [LibraryImport(NativeLib, EntryPoint = "service_async_success")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultError service_async_success2(IntPtr _context, AsyncCallbackCommonNative _async_callback);
        ...
        {
            var (ax, tsk) = _trampolineResultError.NewCall();
            try
            {
