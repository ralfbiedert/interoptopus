...
namespace Gen.ForCSharp
{
    public static partial class Interop
    {
        ...
        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_create_3543445655179195616")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_create_3543445655179195616(IntPtr data, ulong len, ref VecItem rval);


        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_destroy_2012942542194755649")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_destroy_2012942542194755649(VecItem ignored);


        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_create_1973078625036779848")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_create_1973078625036779848(IntPtr data, ulong len, ref VecResult rval);


        [LibraryImport(NativeLib, EntryPoint = "interoptopus_vec_destroy_10426705718220769351")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial long interoptopus_vec_destroy_10426705718220769351(VecResult ignored);
    ...
    public partial class VecItem : IDisposable
    {
        ...
        {
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_create_3543445655179195616")]
            internal static partial long interoptopus_vec_create(IntPtr vec, ulong len, out Unmanaged rval);
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_destroy_2012942542194755649")]
    ...
    public partial class VecResult : IDisposable
    {
        ...
        public partial class InteropHelper
        {
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_create_1973078625036779848")]
            internal static partial long interoptopus_vec_create(IntPtr vec, ulong len, out Unmanaged rval);
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_destroy_10426705718220769351")]
            internal static partial long interoptopus_vec_destroy(Unmanaged vec);
        }
