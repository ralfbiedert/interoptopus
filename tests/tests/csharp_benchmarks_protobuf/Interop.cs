...
namespace My.Company
{
    ...
    public partial class Configuration : IDisposable
    {
        ...
        internal unsafe Unmanaged IntoUnmanaged()
        {
            ...
            _unmanaged.is_local_test = (byte) (is_local_test ? 1 : 0);
            _unmanaged.host = host.IntoUnmanaged();
            _unmanaged.response_size_factor = response_size_factor;
            return _unmanaged;
        }
        ...
        {
            public byte is_local_test;
            public Utf8String.Unmanaged host;
            public ulong response_size_factor;

            [MethodImpl(MethodImplOptions.AggressiveOptimization)]
            internal unsafe Configuration IntoManaged()
            {
                var _managed = new Configuration();
                _managed.is_local_test = is_local_test == 1;
                _managed.host = host.IntoManaged();
                _managed.response_size_factor = response_size_factor;
                return _managed;
            }
        }
