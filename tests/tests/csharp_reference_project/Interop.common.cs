...
namespace My.Company.Common
{
    ...
    [NativeMarshalling(typeof(MyCallbackNamespacedMarshaller))]
    public delegate uint MyCallbackNamespaced(uint value);
    delegate uint MyCallbackNamespacedNative(uint value, IntPtr callback_data);
    // Debug - write_callback_overload 

    // Internal helper that works around an issue where exceptions in callbacks don't reenter Rust.
    [CustomMarshaller(typeof(MyCallbackNamespaced), MarshalMode.Default, typeof(MyCallbackNamespacedMarshaller.Marshaller))]
    public static class MyCallbackNamespacedMarshaller {
        ...
        public ref struct Marshaller
        {
            ...
            private MyCallbackNamespaced marshalled;
            ...
            public unsafe MyCallbackNamespaced ToManaged()
            {
            }
