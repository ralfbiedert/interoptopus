...
namespace My.Company.Common
{
    ...
    public partial class VecSliceU8 : IDisposable
    {
        ...
        {
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_create_6754850874721651329")]
            internal static partial long interoptopus_vec_create(IntPtr vec, ulong len, out Unmanaged rval);
            [LibraryImport(Interop.NativeLib, EntryPoint = "interoptopus_vec_destroy_5722710969548806095")]
