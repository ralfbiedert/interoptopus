...
namespace My.Company
{
    ...
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 8546458626275805029ul)
            {
                throw new TypeLoadException($"API reports hash {api_version} which differs from hash in bindings (8546458626275805029). You probably forgot to update / copy either the bindings or the library.");
            }
        }
        ...
        // Debug - write_function 
        [LibraryImport(NativeLib, EntryPoint = "service_async___async_mock")]
        // Debug - write_function_declaration 
        public static partial void service_async___async_mock(IntPtr context, ulong x, AsyncHelper async_callback);
        // Debug - write_function_overload 
        // Debug - no overload for service_async___async_mock 
    ...
    public partial class ServiceAsync : IDisposable
    {
        ...
        // Debug - write_pattern_service_method 
        public Task<ulong> AsyncMock(ulong x)
        {
            ...
            Interop.service_async___async_mock(_context, x, cb);
            return cs.Task;
        }
