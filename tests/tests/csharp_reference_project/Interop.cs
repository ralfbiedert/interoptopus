...
namespace My.Company
{
    ...
    public static partial class Interop
    {
        ...
        public static void pattern_ffi_slice_3(SliceMut<byte> slice, CallbackSliceMut callback)
        {
            pattern_ffi_slice_3(
                slice, 
                (SliceMutMarshaller<byte>.Unmanaged slice_native, IntPtr callback_data_native) => {
        ...
        public static void pattern_ffi_slice_8(ref SliceMut<CharArray> slice, CallbackCharArray2 callback)
        {
            pattern_ffi_slice_8(
                ref slice, 
                (CharArrayMarshaller.Unmanaged value_native, IntPtr callback_data_native) => {
        ...
        public static byte pattern_ffi_slice_delegate(CallbackFFISlice callback)
        {
            return pattern_ffi_slice_delegate(
                (SliceMarshaller<byte>.Unmanaged slice_native, IntPtr callback_data_native) => {
        ...
        public static Vec3f32 pattern_ffi_slice_delegate_huge(CallbackHugeVecSlice callback)
        {
            return pattern_ffi_slice_delegate_huge(
                (SliceMarshaller<Vec3f32>.Unmanaged slice_native, IntPtr callback_data_native) => {
    ...
    delegate void CallbackCharArray2Native(CharArrayMarshaller.Unmanaged value, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    public class CallbackCharArray2Marshaller {
        ...
        public void Call(CharArray value, IntPtr callback_data)
        {
            try
            {
                return _callback(value, callback_data);
            }
            catch (Exception e)
            {
                failure = e;
    ...
    delegate byte CallbackFFISliceNative(SliceMarshaller<byte>.Unmanaged slice, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    public class CallbackFFISliceMarshaller {
        ...
        public byte Call(Slice<byte> slice, IntPtr callback_data)
        {
            try
            {
                return _callback(slice, callback_data);
            }
            catch (Exception e)
            {
                failure = e;
    ...
    delegate Vec3f32 CallbackHugeVecSliceNative(SliceMarshaller<Vec3f32>.Unmanaged slice, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    public class CallbackHugeVecSliceMarshaller {
        ...
        public Vec3f32 Call(Slice<Vec3f32> slice, IntPtr callback_data)
        {
            try
            {
                return _callback(slice, callback_data);
    ...
    delegate void CallbackSliceMutNative(SliceMutMarshaller<byte>.Unmanaged slice, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    public class CallbackSliceMutMarshaller {
        ...
        public void Call(SliceMut<byte> slice, IntPtr callback_data)
        {
            try
            {
                return _callback(slice, callback_data);
    ...
    delegate byte CallbackU8Native(byte value, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    delegate uint MyCallbackNative(uint value, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    delegate void MyCallbackVoidNative(IntPtr ptr, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    public class MyCallbackVoidMarshaller {
        ...
        public void Call(IntPtr ptr, IntPtr callback_data)
        {
            try
            {
                return _callback(ptr, callback_data);
            }
            catch (Exception e)
            {
                failure = e;
    ...
    delegate void SumDelegate1Native(IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    public class SumDelegate1Marshaller {
        ...
        public void Call(IntPtr callback_data)
        {
            try
            {
                return _callback(callback_data);
            }
            catch (Exception e)
            {
                failure = e;
    ...
    delegate int SumDelegate2Native(int x, int y, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    public class SumDelegate2Marshaller {
        ...
        public int Call(int x, int y, IntPtr callback_data)
        {
            try
            {
                return _callback(x, y, callback_data);
            }
            catch (Exception e)
            {
                failure = e;
    ...
    delegate FFIError SumDelegateReturnNative(int x, int y, IntPtr callback_data);
    // Debug - write_callback_overload 
    ...
    delegate void SumDelegateReturn2Native(int x, int y, IntPtr callback_data);
    // Debug - write_callback_overload 
