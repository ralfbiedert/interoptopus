...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0xd4d5dd0a468acf13)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0xd4d5dd0a468acf13). You probably forgot to update / copy either the bindings or the library.");
            }
        }
