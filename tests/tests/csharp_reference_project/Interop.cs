...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0x291a012ef23f6a0)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0x291a012ef23f6a0). You probably forgot to update / copy either the bindings or the library.");
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultConstPtrServiceAsyncNewError service_async_new_new(IntPtr wrapper, AsyncCallbackCommonNative _async_callback);

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static unsafe Task<IntPtr> service_async_new_new(IntPtr wrapper)
        {
            var (_cb, _cs) = _trampolineResultConstPtrServiceAsyncNewError.NewCall();
            try
            {
                service_async_new_new(wrapper, _cb).AsOk();
                return _cs;
            }
            finally
            {
    ...
    public partial class ServiceAsyncNew : IDisposable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public async static Task<ServiceAsyncNew> New(IntPtr wrapper)
        {
            var self = new ServiceAsyncNew();
            self._context = await Interop.service_async_new_new(wrapper);
            return self;
        }
