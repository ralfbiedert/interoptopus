...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        public static void pattern_callback_7_checked(CallbackError c1, CallbackError c2, int x, int i, out int o)
        {
            var c1_safe_delegate = new CallbackErrorExceptionSafe(c1);
            var c2_safe_delegate = new CallbackErrorExceptionSafe(c2);
            var rval = pattern_callback_7(c1_safe_delegate.Call, c2_safe_delegate.Call, x, i, out o);;
            if (rval != FFIError.Ok)
            {
                throw new InteropException<FFIError>(rval);
            }
            c1_safe_delegate.Rethrow();
            c2_safe_delegate.Rethrow();
        }
        ...
        /// The passed parameter MUST have been created with the corresponding init function;
        /// passing any other value results in undefined behavior.
        public static void service_callbacks_immediate_destroy_checked(ref IntPtr context)
        {
            var rval = service_callbacks_immediate_destroy(ref context);;
            if (rval != FFIError.Ok)
            {
                throw new InteropException<FFIError>(rval);
            }
        ...
        public static void service_callbacks_immediate_new_checked(ref IntPtr context)
        {
            var rval = service_callbacks_immediate_new(ref context);;
            if (rval != FFIError.Ok)
            {
                throw new InteropException<FFIError>(rval);
            }
        ...
        public static void service_callbacks_immediate_callback_simple_checked(IntPtr context, Callback callback)
        {
            var rval = service_callbacks_immediate_callback_simple(context, callback);;
            if (rval != FFIError.Ok)
            {
                throw new InteropException<FFIError>(rval);
            }
        ...
        public static void service_callbacks_immediate_callback_ffi_return_checked(IntPtr context, CallbackError callback)
        {
            var callback_safe_delegate = new CallbackErrorExceptionSafe(callback);
            var rval = service_callbacks_immediate_callback_ffi_return(context, callback_safe_delegate.Call);;
            if (rval != FFIError.Ok)
            {
                throw new InteropException<FFIError>(rval);
            }
        ...
        public static void service_callbacks_immediate_callback_with_slice(IntPtr context, CallbackError callback, int[] input)
        {
            var callback_safe_delegate = new CallbackErrorExceptionSafe(callback);
            ...
            try
            {
                var rval = service_callbacks_immediate_callback_with_slice(context, callback_safe_delegate.Call, input_slice);;
                if (rval != FFIError.Ok)
                {
                    throw new InteropException<FFIError>(rval);
                }
        ...
        /// The passed parameter MUST have been created with the corresponding init function;
        /// passing any other value results in undefined behavior.
        public static void service_callbacks_table_destroy_checked(ref IntPtr context)
        {
            var rval = service_callbacks_table_destroy(ref context);;
            if (rval != FFIError.Ok)
            {
                throw new InteropException<FFIError>(rval);
            }
        ...
        public static void service_callbacks_table_new_checked(ref IntPtr context)
        {
            var rval = service_callbacks_table_new(ref context);;
            if (rval != FFIError.Ok)
            {
                throw new InteropException<FFIError>(rval);
            }
        ...
        public static void service_callbacks_table_invoke_callbacks_checked(IntPtr context)
        {
            var rval = service_callbacks_table_invoke_callbacks(context);;
            if (rval != FFIError.Ok)
            {
                throw new InteropException<FFIError>(rval);
            }
    ...
    public class CallbackErrorExceptionSafe {
        private Exception failure = null;
        private readonly CallbackError _callback;

        public CallbackErrorExceptionSafe(CallbackError original)
        {
            _callback = original;
        }
    ...
    // Internal helper that works around an issue where exceptions in callbacks don't reenter Rust.
    public class CallbackErrorRetainedExceptionSafe {
        private Exception failure = null;
        private readonly CallbackErrorRetained _callback;

        public CallbackErrorRetainedExceptionSafe(CallbackErrorRetained original)
        {
            _callback = original;
        }
    ...
    public partial class ServiceCallbacksImmediate : IDisposable
    {
        ...
        public void CallbackWithSlice(CallbackError callback, int[] input)
        {
            Interop.service_callbacks_immediate_callback_with_slice(_context, callback, input);
        }
