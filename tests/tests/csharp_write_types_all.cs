...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0x25cbb090b53f6a22)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0x25cbb090b53f6a22). You probably forgot to update / copy either the bindings or the library.");
            }
        }
