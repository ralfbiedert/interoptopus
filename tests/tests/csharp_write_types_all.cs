...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0x621914b2a199ef60)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0x621914b2a199ef60). You probably forgot to update / copy either the bindings or the library.");
            }
        }
