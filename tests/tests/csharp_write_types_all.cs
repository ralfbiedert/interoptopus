...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0x45c1dcb9c91cc69e)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0x45c1dcb9c91cc69e). You probably forgot to update / copy either the bindings or the library.");
            }
        }
