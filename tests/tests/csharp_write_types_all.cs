...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0x1ecfe961290ad88b)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0x1ecfe961290ad88b). You probably forgot to update / copy either the bindings or the library.");
            }
        }
        ...
        [LibraryImport(NativeLib, EntryPoint = "service_result_convert_explicit")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultError service_result_convert_explicit(IntPtr _context);


        [LibraryImport(NativeLib, EntryPoint = "service_result_convert_into")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultError service_result_convert_into(IntPtr _context);


        [LibraryImport(NativeLib, EntryPoint = "service_result_convert_attr")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultError service_result_convert_attr(IntPtr _context);
    ...
    public partial class ServiceResult : IDisposable
    {
        ...
        {
            Interop.service_result_convert_explicit(_context).AsOk();
        }

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public void ConvertInto()
        {
            Interop.service_result_convert_into(_context).AsOk();
        }

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public void ConvertAttr()
        {
            Interop.service_result_convert_attr(_context).AsOk();
        }
