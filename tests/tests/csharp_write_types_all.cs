...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0xd0d8b35400e7abc8)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0xd0d8b35400e7abc8). You probably forgot to update / copy either the bindings or the library.");
            }
        }
