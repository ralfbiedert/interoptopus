...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0xe3386600c3d0ca03)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0xe3386600c3d0ca03). You probably forgot to update / copy either the bindings or the library.");
            }
        }
        ...
        [LibraryImport(NativeLib, EntryPoint = "service_result_result_conversion_explicit")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultError service_result_result_conversion_explicit(IntPtr _context);


        [LibraryImport(NativeLib, EntryPoint = "service_result_result_conversion_into")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultError service_result_result_conversion_into(IntPtr _context);


        [LibraryImport(NativeLib, EntryPoint = "service_result_result_conversion_attribute")]
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial ResultError service_result_result_conversion_attribute(IntPtr _context);
    ...
    public partial class ServiceResult : IDisposable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public void ResultConversionExplicit()
        {
            Interop.service_result_result_conversion_explicit(_context).AsOk();
        }

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public void ResultConversionInto()
        {
            Interop.service_result_result_conversion_into(_context).AsOk();
        }

        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public void ResultConversionAttribute()
        {
            Interop.service_result_result_conversion_attribute(_context).AsOk();
        }
