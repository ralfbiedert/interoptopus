...
namespace My.Company
{
    public static partial class Interop
    {
        ...
        static Interop()
        {
            ...
            if (api_version != 0xbf62b8062ad6771b)
            {
                throw new TypeLoadException($"API reports hash 0x{api_version:X} which differs from hash in bindings (0xbf62b8062ad6771b). You probably forgot to update / copy either the bindings or the library.");
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static partial void fnptr_2(InteropDelegate_fn_CharArray_native callback, CharArray x);
